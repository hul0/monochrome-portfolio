      ...
      <div className="max-w-5xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 items-center gap-16 relative z-10">
        ...
        <div className="flex  justify-center lg:justify-end order-2 lg:order-1">
          <div className="relative group">
            ...
            <div className="relative glass-card w-72 h-72 rounded-full p-2 glass border border-primary/50 shadow-[0_0_40px_rgba(168,85,247,0.3)]">
              <img
        ...
        <div className="text-center lg:text-left space-y-8 order-1 lg:order-2">
          ...
          <div className="glass-card px-6 py-4 rounded-3xl inline-block border-primary/20">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start pt-6">
            <a 
              ...
              className="px-10 py-4 bg-primary glass-card text-white rounded-4xl font-bold uppercase tracking-widest hover:bg-white hover:text-primary transition-all duration-300 shadow-[0_0_30px_rgba(168,85,247,0.5)] hover:shadow-[0_0_50px_rgba(168,85,247,0.7)]"
            >
              Join Crew
            </a>
            ...
            <a 
              ...
              className="px-10 py-4 glass-card text-white rounded-4xl font-bold uppercase tracking-widest hover:text-primary transition-all duration-300"
            >
              Send Mail
            </a>
          </div>
          ...
          <p className="text-xs text-primary/60 font-mono mt-8">
            // WARNING: NO PHISHING ATTEMPTS PLEASE
          </p>
        </div>
      </div>
    </section>
