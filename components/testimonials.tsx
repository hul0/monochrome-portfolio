  ...
  return (
    <section id="testimonials" className="min-h-[50vh] flex items-center justify-center px-4 md:px-6 lg:px-8 py-24">
      <div className="max-w-5xl mx-auto w-full text-center">
        <h2 className="text-3xl md:text-5xl font-black mb-16 tracking-tighter text-white uppercase text-glow">
          CLIENT <span className="text-primary">LOGS</span>
        </h2>

        {/* Empty State */}
        <div className="glass-card rounded-4xl p-16 relative overflow-hidden border border-white/10 hover:border-primary/50 transition-colors">
          ...
          <div className="mt-10">
            <a
              ...
              className="inline-flex items-center gap-2 px-10 py-4 bg-primary text-black rounded-4xl font-bold uppercase font-mono hover:bg-white hover:text-primary transition-all duration-300 shadow-lg"
            >
              Submit_Feedback
            </a>
          </div>
