...
const TerminalWindow = ({
  ...
  <div className="w-full glass-card rounded-3xl overflow-hidden border border-white/10 hover:border-primary/30 transition-colors duration-300">
    {/* Terminal Header */}
    <div className="bg-black/40 border-b border-white/5 p-3 px-6 flex items-center gap-4">
      <div className="flex gap-2">
        <div className="w-3 h-3 rounded-full bg-primary"></div>
        <div className="w-3 h-3 rounded-full bg-secondary"></div>
        <div className="w-3 h-3 rounded-full bg-tertiary"></div>
      </div>
      <div className="flex items-center gap-2 text-[10px] font-mono text-white/60 uppercase tracking-widest select-none">
    ...
    <section id="about" className="min-h-screen flex items-center justify-center px-4 md:px-6 lg:px-8 py-24 relative">
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <div className="flex flex-col md:flex-row items-center gap-6 mb-16 border-b border-white/10 pb-8">
          <div className="p-4 glass rounded-full border border-primary/30">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="font-mono text-white/50 text-sm tracking-widest mt-2">
        ...
        <div className="grid xl:grid-cols-12 gap-12">
          ...
          <div className="xl:col-span-5 flex flex-col gap-8 h-full">
            <div className="glass-card p-8 rounded-3xl h-fit sticky top-24">
                  ...
                  <div key={idx} className="group">
                    ...
                    <div className="flex flex-wrap gap-2 pl-4 border-l-2 border-primary/30">
                      {cat.skills.map((skill) => (
                        <span
                          key={skill}
                          className="text-[11px] font-mono px-3 py-1 bg-white/5 rounded-4xl text-gray-300 border border-white/5 hover:border-primary/50 hover:text-white transition-all"
                        >
                          {skill}
                        </span>
                      ))}
              ...
              <div className="relative mt-8 rounded-2xl overflow-hidden border border-white/10">
                <img
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-black/80 backdrop-blur-md border-t border-primary/50 px-4 py-2 flex justify-between items-center">
                  <span className="text-primary text-[10px] font-mono">● LIVE FEED</span>
