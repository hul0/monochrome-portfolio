...
// Reusable Terminal Component for the "Extra Ordinary" look
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="flex items-center gap-4 mb-16 border-b border-red-900/30 pb-8">
        ...
        <div className="grid xl:grid-cols-12 gap-12">
          {/* Left Column: The 4 Floating Terminals */}
          ...
          {/* Right Column: Skills Matrix & Image */}
